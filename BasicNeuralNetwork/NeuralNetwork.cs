...
namespace BasicNeuralNetwork
{
    ...
    public class NeuralNetwork
    {
        ...
        public NeuralNetwork(string json, bool withTraining = false) {
            FromJson(json);
            if (withTraining) {
                trainingOutputs = new float[outputs.Length];
            }
    ...
    {
        public NeuralNetwork network;  // The parent ANN
        ...
        public AnnLayer(NeuralNetwork nn, JsonElement elem, AnnLayerBase previousLayer) :
            this(
                nn,
                previousLayer,
